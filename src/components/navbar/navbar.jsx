    ...
    return (
        ...
        <div className="container-fluid">
            <Link className="logo" to="/">
                <img src="./src/assets/img/logo.svg" alt="Logo" width="250" />
            </Link>
                    ...
                    <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
                        <div className="navbar-nav ml-auto">
                            <ul className="navbar-nav">
                                ...
                                <li className="nav-item">
                                    <Link className="nav-link" to="/Service">contacto</Link>
                                </li>
                                <li className="nav-item">
                        ...
                        <div className="d-flex">
                            ...
                            <span className="material-icons"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="30" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
